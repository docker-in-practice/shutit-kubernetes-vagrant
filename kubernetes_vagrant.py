...
class kubernetes_vagrant(ShutItModule):
	...
	def build(self, shutit):
		...
		if not shutit.file_exists(vagrant_dir + '/kubernetes',directory=True):
		...
		shutit.pause_point('vagrant status')
		return True
	...
	def get_config(self, shutit):
		...
		shutit.get_config(self.module_id, 'clean_vbox', False, boolean=True)
